...
void   sys_exit(uint32 exit_state) __attribute__((noreturn));
...
#endif
_Static_assert(sizeof(file_stat_t) == 16, "user stat ABI");
_Static_assert(__builtin_offsetof(file_stat_t, offset) == 12, "user stat offset");
_Static_assert(sizeof(dentry_t) == 64, "user dentry ABI");
